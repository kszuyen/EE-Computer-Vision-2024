...
ABBR_CAT = ["Kit", "Sto", "Bed", "Liv", "Off", "Ind", "Sub", "Cty", "Bld", "St", "HW", "OC", "Cst", "Mnt", "For"]
...
def main():
    ...
    if args.feature == "tiny_image":
        ...
        if os.path.isfile("vocab.pkl") is False:
            ...
            vocab_size = (
                1000  # vocab_size is up to you, larger values will work better (to a point) but be slower to compute
            )
